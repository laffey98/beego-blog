...
<body>
    ...
    <div class="body">
        <span>有什么事出错了！<br>这肯定不是你的问题！<br>要么就是本大爷的后端服务器坏了，快去联系laffey98那条懒狗来修理老子！<br>记得叫他看运行日志！快去！</span>
        <a class="back" href="javascript:window.history.go(-1)">点此返回上一页</a>
    </div>
</body>
